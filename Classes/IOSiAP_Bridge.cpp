...
void IOSiAP_Bridge:: requestProducts(int id)
{
    ...
    product.push_back("consumble801");
    product.push_back("consumble101");
...
void IOSiAP_Bridge::onRequestProductsFinish(void)
{
    ...
    switch (productID) {
        case 1:
            identifier = "consumble801";
            break;
        case 2:
            identifier = "consumble101";
            break;
        default:
            break;
    }
    ...
    if (event == IOSIAP_PAYMENT_PURCHAED) {
        ...
        switch (productID) {
            case 1:
            {
                ...
                UserDefault::sharedUserDefault()->setIntegerForKey("wealth",UserDefault::sharedUserDefault()->getIntegerForKey("wealth",0)+1000);
                log("%d",UserDefault::sharedUserDefault()->getIntegerForKey("wealth",0));
            ...
            {
                log("%d",UserDefault::sharedUserDefault()->getIntegerForKey("wealth",0));
                UserDefault::sharedUserDefault()->setIntegerForKey("wealth",UserDefault::sharedUserDefault()->getIntegerForKey("wealth",0)+10000);
                log("%d",UserDefault::sharedUserDefault()->getIntegerForKey("wealth",0));
                auto *newIdiomPioneerScene = IdiomPioneer::createScene();
                Director::sharedDirector()->replaceScene(newIdiomPioneerScene);
                break;
